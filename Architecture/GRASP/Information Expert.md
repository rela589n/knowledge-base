The principle that states that the **logic** must be **implemented** in the conceptually **proper classes** for it (that, that **have data** needed to fulfill that logic).
