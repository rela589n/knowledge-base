...
It can only come as we understand the [[Domain Model|Model]] during the [[Model refinement|Refinements]], [[Revealing hidden concepts|Reveal the hidden concepts]], and apply [[Refactoring]].
