[[Smart UI]] and [[Domain Driven Design]] are mutually exclusive design choices. You can't apply both at the same time. Since in [[Smart UI]] there are no layers, no [[Domain Driven Design]] concepts may be used.
