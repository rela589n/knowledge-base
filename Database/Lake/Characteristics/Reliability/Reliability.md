**Reliability** - is the feature of software such that it **continues working** properly even if things do **not go expected** way. Reliable systems are **[[Availability|Fault Tolerant]] or resilient**. ^def-reliability
