The most flexible [[Replication Log|Replication Strategy]], though it has the most overhead. It uses **triggers and stored procedures**.  Databus for [[Oracle]] and [[Bucardo]] for [[PostgreSQL]] works this way.
