The recommended approach to deal with conflicts for most of the cases is **to avoid the conflicts**. The particular records are allowed to be edited only from one particular leader. 
