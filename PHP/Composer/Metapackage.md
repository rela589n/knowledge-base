[[Composer]] metapackage is an empty package (with no code), that may contain requirements and trigger their installation, and the metapackage itself has it's own version. 
